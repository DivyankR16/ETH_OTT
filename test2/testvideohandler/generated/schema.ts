...
export class DisLiked extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save DisLiked entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type DisLiked must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("DisLiked", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): DisLiked | null {
    return changetype<DisLiked | null>(
      store.get_in_block("DisLiked", id.toHexString())
    );
  }

  static load(id: Bytes): DisLiked | null {
    return changetype<DisLiked | null>(store.get("DisLiked", id.toHexString()));
  }
...
export class Liked extends Entity {
  ...
  static loadInBlock(id: Bytes): Liked | null {
    return changetype<Liked | null>(
      store.get_in_block("Liked", id.toHexString())
    );
  }
...
export class Subscribed extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save Subscribed entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type Subscribed must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("Subscribed", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): Subscribed | null {
    return changetype<Subscribed | null>(
      store.get_in_block("Subscribed", id.toHexString())
    );
  }

  static load(id: Bytes): Subscribed | null {
    return changetype<Subscribed | null>(
      store.get("Subscribed", id.toHexString())
    );
  }
  ...
  set subscribe(value: BigInt) {
    this.set("subscribe", Value.fromBigInt(value));
  }
...
export class TransferSingle extends Entity {
  ...
  get EthBiscuits_id(): BigInt {
    let value = this.get("EthBiscuits_id");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set EthBiscuits_id(value: BigInt) {
    this.set("EthBiscuits_id", Value.fromBigInt(value));
  }
...
export class VideoUploaded extends Entity {
  ...
  set VideoURI(value: string) {
    this.set("VideoURI", Value.fromString(value));
  }
  ...
  get discription(): string {
    let value = this.get("discription");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toString();
  ...
  set discription(value: string) {
    this.set("discription", Value.fromString(value));
  }
  ...
  set gaming(value: boolean) {
    this.set("gaming", Value.fromBoolean(value));
  }

  get movies(): boolean {
    let value = this.get("movies");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set movies(value: boolean) {
    this.set("movies", Value.fromBoolean(value));
  }

  get music(): boolean {
    let value = this.get("music");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set music(value: boolean) {
    this.set("music", Value.fromBoolean(value));
  }

  get comedy(): boolean {
    let value = this.get("comedy");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set comedy(value: boolean) {
    this.set("comedy", Value.fromBoolean(value));
  }
  ...
  set education(value: boolean) {
    this.set("education", Value.fromBoolean(value));
  }
